...
# 
# Last Modified: Mon Feb 14 16:08:06 CST 2011
...
# Create a key words in context visualization
# ===========================================
=begin
puts "Do you want to generate a keywords in context visualization? "
kwic_answer = kwic_answer.gets.chomp

if kwic_answer == "yes"
    puts "Enter the target word: "
    target_word = target_word.gets.chomp
    File.open("kwic_output.html", "w") do |output|
        kwic_viz = 
    end
else kwic_answer == "no"
    return
...
# TODO:
#   - add the remainder of the target word code
#   - is 'return' the proper 'else' line?
